...
function [Data, CustomProcessingOpts]=ProcessingPluginExample(app, existFig,CustomFunctionName, PluginsFolderName, OrigData)

%% Create figure
%User Inputs============================================================================================================

%variables
numVar=4; %how many variables

%Give each variable a label
ListofVariableLabels={'Multiplier 1', 'Multiplier 2', 'Multiplier 3','Multiplier 4'};
%============================================================================================================
...
Multiplier1=UserVar{1,2};
Multiplier2=UserVar{2,2};
Multiplier3=UserVar{3,2}; 
Multiplier4=UserVar{4,2}; 

% VV Write your processing code here VV 

Data=OrigData*Multiplier1*Multiplier2*Multiplier3*Multiplier4;
