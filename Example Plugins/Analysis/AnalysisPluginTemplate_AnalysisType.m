...
AnalysisType - '_MEP' or '_SP', to indicate if this is an MEP or SP analysis

!!!
AnalysisType can also be '_Custom' if the analysis is neither MEP or SP, 
...
Using '_Custom' with an onset/offset plugin works, since the user writes the plugin based on what data they expect it to intake
